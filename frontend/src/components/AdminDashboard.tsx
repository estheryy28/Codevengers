...
export default function AdminDashboard() {
    ...
    const handleResetDatabase = async () => {
        ...
        try {
            ...
            const errorMessage = err.response?.data?.message || 'Failed to reset database.';
            alert(errorMessage);
        } finally {
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8 animate-fade-in-up flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-red-600/20 hover:bg-red-600/40 text-red-500 border border-red-600/30 rounded-lg flex items-center gap-2 transition-all hover:scale-105"
                        >
...
<<<<<<< HEAD
                                        <tr key={user._id} className={user.isDisqualified ? 'bg-red-500/10' : ''}>
                                            <td className="font-medium">
                                                {user.username}
                                                {user.isDisqualified && (
                                                    <span className="ml-2 px-2 py-0.5 rounded text-[10px] bg-red-600 text-white uppercase font-bold tracking-wider">
                                                        BANNED
                                                    </span>
                                                )}
                                            </td>
                                            ...
                                            <td>
                                                {user.quizStarted ? (
                                                    <span className="badge badge-warning">
                                                        In Progress ({user.completedQuestions})
                                                    </span>
                                                    ...
                                                    <span className="badge badge-secondary opacity-50">
                                                        Not started
                                                    </span>
                                                )}
                                            </td>
...
<<<<<<< HEAD
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {user.violations >= 3 && <AlertTriangle className="w-4 h-4 text-red-500" />}
                                                </div>
                                            </td>
                                            <td>
=======
>>>>>>> 2ad77c6470fc98a9002d3cc2e22bc860cab2a578
            ...
            {showResetModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
                    <div className="bg-[#1a1a2e] border border-red-500/50 rounded-xl w-full max-w-lg shadow-2xl animate-fade-in-up">
                        <div className="p-6">
                            <div className="flex items-center gap-4 mb-4">
                                <div className="p-3 rounded-full bg-red-500/20 text-red-500">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold text-white">MASTER RESET</h2>
                                    <p className="text-red-400 font-medium">DANGER ZONE</p>
                                </div>
                            </div>

                            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4 mb-6">
                                <p className="text-white/90 mb-2 font-bold">
                                    Are you absolutely sure?
                                </p>
                                <ul className="list-disc list-inside text-white/70 space-y-1 text-sm">
                                    <li>This will <strong>PERMANENTLY DELETE ALL</strong> users, scores, and logs.</li>
                                    <li>The database will be reset to its initial state.</li>
                            ...
                            <div className="flex items-center justify-end gap-3">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white font-bold transition-colors flex items-center gap-2 shadow-lg shadow-red-900/20"
                                    disabled={isResetting}
                                >
                                    {isResetting ? (
                                        <>
