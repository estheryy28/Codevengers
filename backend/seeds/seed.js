...
public class SumDigits {
    public static void main(String[] args) {
        ...
        testCases: [{ input: "123", expectedOutput: "6" }, { input: "9", expectedOutput: "9" }, { input: "456", expectedOutput: "15" }],
        points: 100
    },
    // Code 3: Main Method
    {
...
if marks > 50
    ...
    {
        title: "Sum of Digits",
        description: "Read a positive integer and print sum of its digits.",
        programmingLanguage: "Python",
        difficulty: "easy",
...
print("Average =", avg)`,
    ...
    pass`,
        testCases: [
            { input: "10\n20\n30", expectedOutput: "Average = 20" },
            { input: "5\n5\n5", expectedOutput: "Average = 5" },
            { input: "0\n0\n0", expectedOutput: "Average = 0" },
            { input: "1\n2\n2", expectedOutput: "Average = 1" }
        ],
        points: 150
    },
    // Code 6
...
int main() {
    ...
    {
        title: "Sum of Digits",
        description: "Read a positive integer. Print sum of digits.",
        programmingLanguage: "C",
        difficulty: "easy",
        buggyCode: `#include <stdio.h>
int main() {
...
int main() {
    ...
    {
        title: "Sum of Series",
        description: "Read N. Print sum of 1 to N.",
        programmingLanguage: "C",
        difficulty: "easy",
        buggyCode: `#include <stdio.h>
int main() {
